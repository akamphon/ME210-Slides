...
\begin{frame}[label={sec:org8a2876c}]{State of Stress of of Vessel Wall}
\begin{center}
\includegraphics[height=0.9\textheight]{pictures/state-of-stress-spherical.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org15ec1f5}]{Mohr's Circle of State of Stress}
\begin{center}
\includegraphics[width=.9\linewidth]{pictures/mohrs-sphere-vessel.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:orga1bddfb}]{Absolute Maximum Shear Stress of Spherical Pressure Vessel}
\begin{center}
\includegraphics[width=.9\linewidth]{pictures/abs-max-shear-sphere-vessel.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org9640455}]{Spherical Pressure Vessel: Summary}
\begin{itemize}
...
\begin{frame}[label={sec:org4485539}]{Cylindrical Pressure Vessels}
\begin{columns}
...
\begin{frame}[label={sec:orgfee4c3b}]{State of Stress of of Vessel Wall}
\begin{center}
\includegraphics[width=.9\linewidth]{pictures/state-of-stress-cyl.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org54b327b}]{Mohr's Circle of Cylindrical Vessel}
\begin{center}
