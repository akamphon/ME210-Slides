...
\begin{frame}[label={sec:org0d7bb77}]{Cartesian}
\begin{center}
...
\begin{frame}[label={sec:org0ece42e}]{Cylindrical}
\begin{center}
...
\begin{frame}[label={sec:org59bcbdf}]{Spherical Coordinates}
\begin{center}
...
\begin{frame}[label={sec:orgbad395b}]{External Loads}
\begin{itemize}
...
\begin{frame}[label={sec:org4f1063d}]{Surface Direction}
\begin{itemize}
...
\begin{frame}[label={sec:orgb17caf8}]{Forces}
\begin{itemize}
...
\begin{frame}[label={sec:org1b243b2}]{Stress - Strain Diagram: Ductile}
\footnotesize
...
\begin{frame}[label={sec:org17d5682}]{Elastic Region}
\begin{itemize}
...
\begin{frame}[label={sec:org653ef79}]{Modulus of Resilience}
\begin{figure}[h]
  \centering
  \begin{tikzpicture}
...
\begin{frame}[label={sec:org707dcf4}]{Modulus of Toughness}
\begin{figure}[h]
  \centering
  \begin{tikzpicture}
    \draw [thick] (0,4.5) node[above]{$\sigma$} --++ (-90:4.5) --++ (0:6) node[right]{$\varepsilon$};
...
\begin{frame}[label={sec:org9c2fb5d}]{Shear Stress-Strain Relationship}
\begin{figure}[h]
  \centering
...
\begin{frame}[label={sec:orge543e87}]{Poisson's Effect}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{figure}
  \centering
