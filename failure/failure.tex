...
\label{sec:org5c397e8}

\begin{frame}[label={sec:org20c122b}]{Material Failure}
\begin{itemize}
...
\label{sec:org336df6b}

\begin{frame}[label={sec:org21fb7ad}]{Fracture \& Yield}
\begin{itemize}
...
\begin{frame}[label={sec:org8dd86da}]{Design Equation for MNST}
\begin{columns}
\begin{column}{0.4\columnwidth}
if \(\sigma_1 > \sigma_2\)
...
\begin{frame}[label={sec:org0012f6f}]{Example: The Many Modes of Chalk Fracture}
\begin{itemize}
...
\begin{frame}[label={sec:org1f3d951}]{Design Equation for MSST}
\begin{columns}
\begin{column}{0.4\columnwidth}
\begin{gather*}
...
\begin{frame}[label={sec:org7f7b3a5}]{Example: Ductile shaft under torsion}
\begin{tikzpicture}[>=latex]
\node[draw, pattern=north east lines, trapezium, trapezium left angle=120, trapezium right angle=60, minimum height=1.5cm, rotate=90](wall){};
\draw [line cap=round, double=Grey, rounded corners=5mm, double distance=0.5cm] (wall.center) --++ (-25:6) node(end){};
\node at (end.center) [draw, ellipse, minimum height=0.5cm, minimum width=0.5cm](outerend){};
...
\begin{frame}[label={sec:org444dc35}]{Design Equation for MDET}
\begin{columns}
\begin{column}{0.4\columnwidth}
...
\begin{frame}[label={sec:org1b511bd}]{Comparison Between Different Criteria}
\begin{figure}[h]
\centering
\begin{tikzpicture}[>=latex]
...
\section{Fatigue}
\label{sec:org7dc3943}

\begin{frame}[label={sec:orgf1d0f88}]{Fatigue}
\begin{columns}
...
\begin{frame}[label={sec:orgecd17b8}]{Repeated Loading}
\begin{itemize}
...
\begin{frame}[label={sec:org786d39a}]{Testing for Fatigue\}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org2cf1139}]{S-N or Endurance Diagram}
\begin{tikzpicture}[>=latex]
...
\begin{frame}[label={sec:org44ca9b3}]{Endurance Limit or Fatigue Limit}
...
\begin{frame}[label={sec:org0ce9560}]{Fatigue Failure with Nonzero Average Stress}
\centering
\begin{tikzpicture}[>=latex]
...
\begin{frame}[label={sec:org21eb731}]{Average Stress Correction Equations}
\begin{itemize}
...
\begin{frame}[label={sec:org3309c5c}]{Governing Equation of Buckling}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\begin{frame}[label={sec:org632fd07}]{Solving for Buckling}
...
\begin{frame}[label={sec:org714f15e}]{Buckling in Fixed - Free Supports}
\begin{tikzpicture}[>=latex]
...
\begin{frame}[label={sec:org8f8a6e0}]{Governing Differential Equation Solution}
...
\begin{frame}[label={sec:org21b4a6c}]{}
...
\begin{frame}[label={sec:org573eab7}]{Generalized Critical Load}
\begin{align*}
...
\begin{frame}[label={sec:org47188d9}]{Buckling in Other Types of Supports}
\begin{center}
...
\begin{frame}[label={sec:orgec584f6}]{Slenderness Ratio \(\lambda\)}
\begin{itemize}
...
\begin{frame}[label={sec:org47c91db}]{Buckling Design Equation}
\begin{align*}
...
\begin{frame}[label={sec:org8a13574}]{Example: Buckling of a Railroad Track in the Sun}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
