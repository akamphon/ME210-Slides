...
\begin{frame}[label={sec:org4c91ba8}]{Elastic Deformation of Axially Loaded Members}
\begin{figure}[h]
  \centering
  \begin{tikzpicture}
...
\begin{frame}[label={sec:org3b32294}]{Hooke's Law}
\begin{align*}
...
\begin{frame}[label={sec:org652b917}]{Generalized Elastic Deformation}
\begin{figure}[h]
  \centering
  \begin{tikzpicture}
    \draw[fill=Grey] (-1,-1) rectangle (0,2);
...
\begin{frame}[label={sec:org05a1e3f}]{Specific Conditions}
\begin{itemize}
...
\begin{frame}[label={sec:orgc9e6071}]{Deformation Analysis Steps}
\begin{enumerate}
...
\begin{frame}[label={sec:org7327cac}]{Finding Internal Forces}
\begin{enumerate}
...
\begin{frame}[label={sec:org227b0ca}]{Example: Prismatic Bar}
\begin{itemize}
...
\begin{frame}[label={sec:org158102d}]{Example: Same bars, Same forces, Different locations}
\begin{figure}[h]
\begin{tikzpicture}
...
\begin{frame}[label={sec:org267344f}]{Example: Deformation of a continuously variable bar}
\begin{itemize}
...
\begin{frame}[label={sec:orgc43ab27}]{Solution}
\begin{itemize}
...
\begin{frame}[label={sec:org9bf7171}]{Compatibility or Kinematic Conditions}
\begin{itemize}
...
\begin{frame}[label={sec:org19d0ce7}]{Example: Basic Bar between Two Walls}
\begin{columns}
...
\begin{frame}[label={sec:org203ec60}]{Solving SI Problems}
\begin{enumerate}
...
\begin{frame}[label={sec:orgf4724e2}]{Example: Three Bars attached to Rigid Beam}
\begin{figure}[H]
  \centering
...
\begin{frame}[label={sec:orga6d2c23}]{Solution}
...
\begin{frame}[label={sec:org66e8cb7}]{Example: Thermal Stress in Fastened Bars}
\begin{figure}[H]
  \centering
  \begin{tikzpicture}[>=latex]
    \node [draw, rectangle, minimum height=0.5cm, minimum width=5cm, fill=Grey](rigid){};
...
\begin{frame}[label={sec:orgc01c372}]{Solution}
...
\begin{frame}[label={sec:orgb2eb7e5}]{Solution}
...
\begin{frame}[label={sec:org73b6ffe}]{Object under Impact Loading}
\begin{figure}[h]
  \centering
  \begin{tikzpicture}
...
\begin{frame}[label={sec:org131423f}]{Maximum Deformation under Impact Loading}
\begin{itemize}
